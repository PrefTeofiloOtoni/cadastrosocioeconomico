    ...
    <div class="col-lg-12">
     ...
     <form class="form-signin" action="formulariophp" name="form1" method="POST">
      <table class='table table-striped table-bordered'>
       <tr>
        <td colspan="4"><label>Nome:</label> <?php echo ucfirst($_SESSION['RECADASTRO']['Nome'])?></td>
       </tr>
       <tr>
       ...
       <tr>
        <td colspan="3"><label>E-Mail:</label> <?php echo ucfirst($_SESSION['RECADASTRO']['Email'])?></td>
       ...
       <tr>
        ...
        <td><label>Estado Civíl:</label> <?php echo ucfirst($_SESSION['RECADASTRO']['EstCivil'])?> </td> 
        <td colspan="2">
       ...
       <tr>
        ...
        <td><label>Quitada:</label> <?php echo ucfirst(getSimNao($_SESSION['RECADASTRO']['Hab_Quit']))?></td>
        <td><?php if($_SESSION['RECADASTRO']['Hab_Quit']=="sim"){?> <label>Valor:</label> R$<?php echo ucfirst($_SESSION['RECADASTRO']['Hab_Valor']); }?></td>
       </tr>
       <tr>
...
<?php
 if(($_SESSION['RECADASTRO']['Trans_Forma']=="carro")||($_SESSION['RECADASTRO']['Trans_Forma']=="moto")){
   echo "<br /><label>Próprio: </label>".ucfirst($_SESSION['RECADASTRO']['Trans_Tipo']);
 } ?>
        </td>
       </tr>
       <tr>
       ...
       <tr>
        <td colspan="4"><label>Informática:</label><br>
         ...
         <?php if(!isset($_SESSION['RECADASTRO']['Info_Outros'])){ ?> <label>Outros:</label> <?php echo ucfirst($_SESSION['RECADASTRO']['Info_Outros']); }?>
        </td>
       </tr>
       <tr>
        <td colspan ="4">
         <table class='table table-striped table-bordered table-hover'>
          ...
          <?php getComposicaoFamiliar($_SESSION['RECADASTRO']['CPF']) ?>
         </table>
        </td>
       </tr>
       <tr>
      ...
      <tr><td colspan="4"><label>Quem é a pessoa que mais contribui na renda familiar?</label> <?php echo ucfirst($_SESSION['RECADASTRO']['Renda_Maior'])?></td></tr> 
     ...
     <table>
      ...
      <tr>
       <td colspan="4">
        ...
        <p><center><?php echo ucfirst($_SESSION['RECADASTRO']['Nome'])?></center></p>
       </td>
      </tr>
     </table>
    </div>
